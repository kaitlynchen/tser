        ...
        do
            ...
            do
                ...
                python main.py --comment "ClimaX on ${DATA}" \
                    --seed $SEED --name ${DATA}_CONVALIBI \
                    --records_file output_repro/${DATA}_CONVALIBI.xls \
...
#                 python main.py --comment "ClimaX on ${DATA}" \
#                     --seed $SEED --name CLIMAX_NORMALIZE_${DATA}_TUNING \
#                     --records_file output_repro/CLIMAX_NORMALIZE_${DATA}_TUNING.xls \
#                     --data_dir /mnt/beegfs/bulk/mirror/jyf6/datasets/TSER/$DATA/ --data_class tsra \
#                     --pattern TRAIN --val_pattern TEST --epochs 1000 --lr $LR --batch_size 16 \
#                     --num_layers 3 --num_heads 8 --d_model 128 --dim_feedforward 512 \
#                     --optimizer RAdam --task regression \
#                     --plot_loss --plot_accuracy --normalize_label \
#                     --model climax_smooth --patch_length 1 --stride 1 --smooth_attention \
#                     --pos_encoding learnable_zero_init --where_to_add_abspos pooling_before_softmax \
