...
class ClimaX(nn.Module):
    ...
    def __init__(
        ...
        # (self, dim, patch_dim, num_heads,  mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                #  drop_path=0., act_layer=nn.GELU, norm_layer=nn.BatchNorm1d, use_gpsa=True, **kwargs)
    ...
    def forward(self, x):
        ...
        """
        out_transformers, attn_weights = self.forward_encoder(x)  # B, L, D
